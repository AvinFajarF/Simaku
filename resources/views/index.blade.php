  ...
  <div class="flex justify-center">
      <div class="container max-w-6xl px-4">
          <div class="flex justify-between items-center">
              <a class="text-xl font-semibold text-white lg:text-2xl">
                SiMa-Ku
              </a>
              <a class="flex items-center text-sm font-normal text-white md:text-base" id="modal-open">
      ...
      <div class="container px-4 max-w-6xl">
          <div class="-mx-0 flex flex-wrap md:-mx-4">
            <div class="mb-8 w-full px-0 md:w-6/12 md:mb-0 md:px-4">
              <div>
                <p class="mb-4 max-w-md text-base font-medium text-white md:text-base">Hi, </p>
